...
public class TextFileModificationProgram {
	static void modifyFile(String filePath, String fileName, String extention, String oldString[], String newString[]) {
		...
		try {
			...
			createFile(filePath + "/" + newString[1], newString[1] + fileName, content);
	...
	public static void main(String[] args) {
		...
		String old[] = { "<package>", "<ClassName>", "<ClassNameLowerCase>" };
		String newString[] = { "com.bjit.training", "User", "user" };
		String files[] = { "Controller", "Repository", "Service" };
		String extention = ".java";
		for (int i = 0; i < files.length; i++)
			modifyFile("/home/mahidi-hassain117/Desktop/template", files[i], extention, old, newString);
